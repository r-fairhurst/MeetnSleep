...
* **GitHub Repo:**  
  * [https://github.com/r-fairhurst/MeetnSleep](https://github.com/r-fairhurst/MeetnSleep)   
...
1. Open source:  
   1. The source code for this application will be available to anyone to look at and view. Any imported libraries for transcription or LLM APIs will be credited to the original creators.  
2. Reliability:  
   1. The program will work successfully 99.99% of the time. Failures should be rare and recoverable.  
3. Readability:  
   1. The code for the application programmer creates easily readable and understandable code, so other developers can understand what was written.  
4. Security:  
   1. The program will not store any transcript or summary unless the user agrees.  
   2. No unintended background recording (the user needs to explicitly enable the transcript). 
...
| Week 5  | Team Leader: Meet with TA Full stack: Help the frontend team with creating the main page of the program and help them debug in case of any issue with the baclend. Backend: Refine both backend prototypes, have testers test the backend project, report progress to team leader and team.  Frontend: Start working on the main page of the program DevOps: Turn in any related team work to canvas and or github QA Tester:  Test the current version of the project for bugs and issues. Report any issues to the rest of the team. |
| Week 6 | Team Leader: Meet with TA Full stack: Debug the completed part of the program. Backend: Iron out bugs in the backend system, connect with frontend gui. Frontend: Have the main page of the UI completed and connect it with the backend. Start working on the archive page of the application  DevOps: Turn in any related team work to canvas and or github QA Tester:  Test the current version of the project for bugs and issues. Report any issues to the rest of the team. |
| Week 7 | Team Leader: Meet with TA Full stack: test the system and fix any issues. Backend: Have testers stress test the system, refine backend systems in relation with the test findings. Frontend: Continue working on the archive page of the application  DevOps: Turn in any related team work to canvas and or github QA Tester:  Test the current version of the project for bugs and issues. Report any issues to the rest of the team. |
| Week 8 | Team Leader: Meet with TA Full stack: Optimize the code. Backend: Finish all backend related use cases, iron out bugs, test system. Frontend: Have the archive page of the UI completed and connect it with the backend. Start working on any additional features/page. DevOps: Turn in any related team work to canvas and or github QA Tester:  Test the current version of the project for bugs and issues. Report any issues to the rest of the team. |
| Week 9 | Team Leader: Meet with TA Full stack: help the backend and frontend to finalize the application. Backend: Finalize application backend.  Frontend: Finish creating any additional features/pages and connect them with the backend  DevOps: Turn in any related teamwork to canvas and or github QA Tester:  Test the current version of the project for bugs and issues. Report any issues to the rest of the team. |
| Week 10 | Team Leader: Meet with TA Full stack: Be ready to fix anything before the release of the app. Backend: Clean up code, refine backend methods Frontend: Add final details to UI and ensure all pages are connected to backend DevOps: Fully make the final deployed product of our program and turn in any related team work to canvas and or github QA Tester:  Test the current version of the project for bugs and issues. Report any issues to the rest of the team. |
...
| Week 5  | Finalize the project design specifications Begin project Implementation Multiple points of recording of audio (e.g. mic, desktop app, etc) Speech to text |
| Week 6 | Project implementation Saving meeting transcripts Summary of text |
| Week 7 | Project Implementation Create a desktop GUI |
| Week 8 | Project Testing Test for any bugs or issues with speech-to-text Project Beta Deployment Have a semi-finished desktop application that has all the project implementations above working |
